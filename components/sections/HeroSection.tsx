    ...
    <section className="w-full bg-white dark:bg-gray-900 py-16 px-4 md:px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full md:w-1/2">
          <div className="relative w-full h-64 md:h-80 lg:h-96 overflow-hidden bg-gray-200 dark:bg-gray-800">
            {imageUrl ? (
              <Image
                src={imageUrl}
                alt={section.title}
          ...
          {showExtraInput ? (
            <>
              ...
              <input
                ...
                className="w-full p-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#432DD7] placeholder-gray-400 dark:placeholder-gray-500"
              />
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4">
                ...
                <label className="flex items-center gap-2 text-sm cursor-pointer text-gray-700 dark:text-gray-300">
                  <input
                    ...
                    className="w-4 h-4 text-[#432DD7] border-gray-300 dark:border-gray-600 rounded focus:ring-[#432DD7] bg-white dark:bg-gray-800"
                  />
